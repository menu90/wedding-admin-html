...
export const appRouter = [
    ...
    },*/
    {
        ...
        children: [//aceess 1可以访问 0 不能访问
            ...
            { path: 'user', title: '用户管理', name: 'user',access:1, component: resolve => { require(['@/views/access/access.vue'], resolve); } },
            { path: 'param', title: '参数管理', name: 'param',access:1, component: resolve => { require(['@/views/access/access.vue'], resolve); } }
        ]
    },
    {
        path: '/component',
